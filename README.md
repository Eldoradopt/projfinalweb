# 🛍️ BazarIPT — Marketplace de Artigos em Segunda Mão

Este é o **BazarIPT**, um website moderno e intuitivo de compra e venda de artigos de segunda mão, desenvolvido especificamente para a comunidade académica do **Instituto Politécnico de Tomar (IPT)**. A plataforma permite que os estudantes e docentes comprem, vendam e troquem artigos de forma rápida, segura e sustentável.

---

## ✨ Funcionalidades Principais (Fase 1 & Fase 2)

### 🎨 1. Design & Experiência de Utilizador (UX/UI Premium)
...
### 📝 2. Publicação de Anúncios Reativa (`/Anuncios/Create`)
...
### 🔍 3. Catálogo Inteligente com Filtros e Ordenação (`/Anuncios/Index`)
...
### 👤 4. Detalhes de Artigo Premium (`/Anuncios/Details`)
